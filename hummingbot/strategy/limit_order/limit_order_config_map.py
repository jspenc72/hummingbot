...
limit_order_config_map ={
    ...
    "limit_price":
        ConfigVar(key="limit_price",
                  prompt="Enter maximum you want to pay per transaction>>> ",
                  prompt_on_new=True,
    ),   
    "limit_percentage":
        ConfigVar(key="limit_percentage",
                  prompt="Enter percentage drop before buy order is submitted>>> ",
                  prompt_on_new=True,
    ),        
    "market": ConfigVar(
        key="market",
