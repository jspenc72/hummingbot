...
class TerraswapConnector(ConnectorBase):
    """
    ...
    def __init__(self,
                 terraswap_wallet_address: str,
                 terraswap_wallet_seeds: str,
        ...
        """
        super().__init__()
        self._terra_wallet_address = terraswap_wallet_address
        self._terra_wallet_seeds = terraswap_wallet_seeds
